...
sudo ./scripts/create_bridge.sh "$host_phy_interface" "$bridge_interface" "$bridge_ip_address"
echo "Created bridge '$bridge_interface'"
sudo ip netns add $namespace
sudo ./scripts/setup_network_namespace.sh "$bridge_interface" "$bridge_ip_address" "$namespace" "$namespace_ip_address"
